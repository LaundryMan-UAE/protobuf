...
FOUNDATION_EXPORT void ComGoogleProtobufNanoUnknownFieldData_initPackagePrivateWithInt_withByteArray_(ComGoogleProtobufNanoUnknownFieldData *self, jint tag, IOSByteArray *bytes);

FOUNDATION_EXPORT ComGoogleProtobufNanoUnknownFieldData *new_ComGoogleProtobufNanoUnknownFieldData_initPackagePrivateWithInt_withByteArray_(jint tag, IOSByteArray *bytes) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleProtobufNanoUnknownFieldData *create_ComGoogleProtobufNanoUnknownFieldData_initPackagePrivateWithInt_withByteArray_(jint tag, IOSByteArray *bytes);
