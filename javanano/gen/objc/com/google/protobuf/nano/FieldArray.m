...
+ (void)initialize {
  if (self == [ComGoogleProtobufNanoFieldArray class]) {
    JreStrongAssignAndConsume(&ComGoogleProtobufNanoFieldArray_DELETED, new_ComGoogleProtobufNanoFieldData_initPackagePrivate());
...
jint ComGoogleProtobufNanoFieldArray_idealIntArraySizeWithInt_(ComGoogleProtobufNanoFieldArray *self, jint need) {
  return JreIntDiv(ComGoogleProtobufNanoFieldArray_idealByteArraySizeWithInt_(self, need * 4), 4);
}
