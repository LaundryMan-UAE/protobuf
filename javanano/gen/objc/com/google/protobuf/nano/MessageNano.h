...
/*!
 @brief Provides support for cloning.This only works if you specify the generate_clone method.
 */
...
/*!
 @brief Serialize to a byte array starting at offset through length.The
  method getSerializedSize must have been called prior to calling
  this method so the proper length is know.
 If an attempt to
...
/*!
 @brief Returns a string that is (mostly) compatible with ProtoBuffer's TextFormat.Note that groups
...
/*!
 ...
 @throw IOExceptionif an error occurred writing to <code>output</code>.
 */
...
/*!
 @brief Computes the number of bytes required to encode this message.This does not update the
  cached size.
 */
