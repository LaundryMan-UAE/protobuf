...
/*!
 @brief Verifies that <code>spaceLeft()</code> returns zero.
 It's common to create
 a byte array that is exactly big enough to hold a message, then write to
 it with a <code>CodedOutputStream</code>.  Calling <code>checkNoSpaceLeft()</code>
...
/*!
 ...
 byte array.
 If more bytes are written than fit in the array,
 <code>OutOfSpaceException</code> will be thrown.  Writing directly to a flat
...
/*!
 @brief Create a new <code>CodedOutputStream</code> that writes directly to the given
 byte array slice.
 If more bytes are written than fit in the slice,
 <code>OutOfSpaceException</code> will be thrown.  Writing directly to a flat
 array is faster than writing to an <code>OutputStream</code>.
 */
