...
#ifndef _ComGoogleProtobufNanoCodedOutputByteBufferNano_H_
#define _ComGoogleProtobufNanoCodedOutputByteBufferNano_H_
...
/**
 @brief Verifies that #spaceLeft() returns zero.
 It's common to create a byte array that is exactly big enough to hold a message, then write to it with a <code>CodedOutputStream</code> .  Calling <code>checkNoSpaceLeft()</code> after writing verifies that the message was actually as big as expected, which can help catch bugs.
 */
- (void)checkNoSpaceLeft;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>bool</code> field, including tag.
 */
+ (jint)computeBoolSizeWithInt:(jint)fieldNumber
                   withBoolean:(jboolean)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>bool</code> field.
 */
+ (jint)computeBoolSizeNoTagWithBoolean:(jboolean)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>bytes</code> field, including tag.
 */
+ (jint)computeBytesSizeWithInt:(jint)fieldNumber
                  withByteArray:(IOSByteArray *)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>bytes</code> field.
 */
+ (jint)computeBytesSizeNoTagWithByteArray:(IOSByteArray *)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>double</code> field, including tag.
 */
...
/**
 @brief Compute the number of bytes that would be needed to encode an enum field, including tag.
...
/**
 @brief Compute the number of bytes that would be needed to encode a <code>fixed32</code> field, including tag.
 */
+ (jint)computeFixed32SizeWithInt:(jint)fieldNumber
                          withInt:(jint)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>fixed32</code> field.
 */
+ (jint)computeFixed32SizeNoTagWithInt:(jint)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>fixed64</code> field, including tag.
 */
+ (jint)computeFixed64SizeWithInt:(jint)fieldNumber
                         withLong:(jlong)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>fixed64</code> field.
 */
+ (jint)computeFixed64SizeNoTagWithLong:(jlong)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>float</code> field, including tag.
 */
...
/**
 @brief Compute the number of bytes that would be needed to encode a <code>group</code> field, including tag.
 */
+ (jint)computeGroupSizeWithInt:(jint)fieldNumber
withComGoogleProtobufNanoMessageNano:(ComGoogleProtobufNanoMessageNano *)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>group</code> field.
 */
+ (jint)computeGroupSizeNoTagWithComGoogleProtobufNanoMessageNano:(ComGoogleProtobufNanoMessageNano *)value;

/**
 @brief Compute the number of bytes that would be needed to encode an <code>int32</code> field, including tag.
 */
...
/**
 @brief Compute the number of bytes that would be needed to encode an <code>int64</code> field, including tag.
 */
...
/**
 @brief Compute the number of bytes that would be needed to encode an embedded message field, including tag.
 */
+ (jint)computeMessageSizeWithInt:(jint)fieldNumber
withComGoogleProtobufNanoMessageNano:(ComGoogleProtobufNanoMessageNano *)value;

/**
 @brief Compute the number of bytes that would be needed to encode an embedded message field.
 */
...
/**
 ...
 <code>value</code> is treated as unsigned, so it won't be sign-extended if negative.
 */
...
/**
 @brief Compute the number of bytes that would be needed to encode an <code>sfixed32</code> field, including tag.
 */
+ (jint)computeSFixed32SizeWithInt:(jint)fieldNumber
                           withInt:(jint)value;

/**
 @brief Compute the number of bytes that would be needed to encode an <code>sfixed32</code> field.
 */
+ (jint)computeSFixed32SizeNoTagWithInt:(jint)value;

/**
 @brief Compute the number of bytes that would be needed to encode an <code>sfixed64</code> field, including tag.
 */
+ (jint)computeSFixed64SizeWithInt:(jint)fieldNumber
                          withLong:(jlong)value;

/**
 @brief Compute the number of bytes that would be needed to encode an <code>sfixed64</code> field.
 */
+ (jint)computeSFixed64SizeNoTagWithLong:(jlong)value;

/**
 @brief Compute the number of bytes that would be needed to encode an <code>sint32</code> field, including tag.
 */
+ (jint)computeSInt32SizeWithInt:(jint)fieldNumber
                         withInt:(jint)value;

/**
 @brief Compute the number of bytes that would be needed to encode an <code>sint32</code> field.
 */
+ (jint)computeSInt32SizeNoTagWithInt:(jint)value;

/**
 @brief Compute the number of bytes that would be needed to encode an <code>sint64</code> field, including tag.
 */
+ (jint)computeSInt64SizeWithInt:(jint)fieldNumber
                        withLong:(jlong)value;

/**
 @brief Compute the number of bytes that would be needed to encode an <code>sint64</code> field.
 */
+ (jint)computeSInt64SizeNoTagWithLong:(jlong)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>string</code> field, including tag.
 */
+ (jint)computeStringSizeWithInt:(jint)fieldNumber
                    withNSString:(NSString *)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>string</code> field.
 */
...
/**
 @brief Compute the number of bytes that would be needed to encode a <code>uint32</code> field, including tag.
 */
+ (jint)computeUInt32SizeWithInt:(jint)fieldNumber
                         withInt:(jint)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>uint32</code> field.
 */
+ (jint)computeUInt32SizeNoTagWithInt:(jint)value;

/**
 @brief Compute the number of bytes that would be needed to encode a <code>uint64</code> field, including tag.
 */
...
/**
 @brief Encode a ZigZag-encoded 32-bit value.
...
/**
 @brief Encode a ZigZag-encoded 64-bit value.
 ZigZag encodes signed integers into values that can be efficiently encoded with varint.  (Otherwise, negative values must be sign-extended to 64 bits to be varint encoded, thus always taking 10 bytes on the wire.)
...
/**
 @brief Create a new <code>CodedOutputStream</code> that writes directly to the given byte array.
 If more bytes are written than fit in the array, OutOfSpaceException will be thrown.  Writing directly to a flat array is faster than writing to an <code>OutputStream</code> .
 */
+ (ComGoogleProtobufNanoCodedOutputByteBufferNano *)newInstanceWithByteArray:(IOSByteArray *)flatArray OBJC_METHOD_FAMILY_NONE;

/**
 @brief Create a new <code>CodedOutputStream</code> that writes directly to the given byte array slice.
 If more bytes are written than fit in the slice, OutOfSpaceException will be thrown.  Writing directly to a flat array is faster than writing to an <code>OutputStream</code> .
 */
...
/**
 @brief Write an enum field, including tag, to the stream.
 Caller is responsible for converting the enum value to its numeric value.
 */
...
/**
 @brief Write an enum field to the stream.
 Caller is responsible for converting the enum value to its numeric value.
 */
...
J2OBJC_STATIC_FIELD_GETTER(ComGoogleProtobufNanoCodedOutputByteBufferNano, LITTLE_ENDIAN_32_SIZE, jint)

J2OBJC_STATIC_FIELD_GETTER(ComGoogleProtobufNanoCodedOutputByteBufferNano, LITTLE_ENDIAN_64_SIZE, jint)
...
/**
 @brief If you create a CodedOutputStream around a simple flat array, you must not attempt to write more bytes than the array has space.
...
#endif // _ComGoogleProtobufNanoCodedOutputByteBufferNano_H_
