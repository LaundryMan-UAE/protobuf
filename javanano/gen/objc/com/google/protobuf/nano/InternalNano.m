...
JavaNioCharsetCharset *ComGoogleProtobufNanoInternalNano_UTF_8_;
JavaNioCharsetCharset *ComGoogleProtobufNanoInternalNano_ISO_8859_1_;
id ComGoogleProtobufNanoInternalNano_LAZY_INIT_LOCK_;
...
NSString *ComGoogleProtobufNanoInternalNano_stringDefaultValueWithNSString_(NSString *bytes) {
  ...
  return [NSString stringWithBytes:[((NSString *) nil_chk(bytes)) getBytesWithCharset:ComGoogleProtobufNanoInternalNano_ISO_8859_1_] charset:ComGoogleProtobufNanoInternalNano_UTF_8_];
}

IOSByteArray *ComGoogleProtobufNanoInternalNano_bytesDefaultValueWithNSString_(NSString *bytes) {
  ComGoogleProtobufNanoInternalNano_initialize();
  return [((NSString *) nil_chk(bytes)) getBytesWithCharset:ComGoogleProtobufNanoInternalNano_ISO_8859_1_];
}

IOSByteArray *ComGoogleProtobufNanoInternalNano_copyFromUtf8WithNSString_(NSString *text) {
  ComGoogleProtobufNanoInternalNano_initialize();
  return [((NSString *) nil_chk(text)) getBytesWithCharset:ComGoogleProtobufNanoInternalNano_UTF_8_];
}
...
id<JavaUtilMap> ComGoogleProtobufNanoInternalNano_mergeMapEntryWithComGoogleProtobufNanoCodedInputByteBufferNano_withJavaUtilMap_withComGoogleProtobufNanoMapFactories_MapFactory_withInt_withInt_withId_withInt_withInt_(ComGoogleProtobufNanoCodedInputByteBufferNano *input, id<JavaUtilMap> map, id<ComGoogleProtobufNanoMapFactories_MapFactory> mapFactory, jint keyType, jint valueType, id value, jint keyTag, jint valueTag) {
  ...
  while (true) {
    ...
    if (tag == keyTag) {
      key = (id) [input readPrimitiveFieldWithInt:keyType];
    }
    else if (tag == valueTag) {
      if (valueType == ComGoogleProtobufNanoInternalNano_TYPE_MESSAGE) {
        [input readMessageWithComGoogleProtobufNanoMessageNano:(ComGoogleProtobufNanoMessageNano *) check_class_cast(value, [ComGoogleProtobufNanoMessageNano class])];
      }
      else {
        value = (id) [input readPrimitiveFieldWithInt:valueType];
      }
    }
    else {
  ...
  if (key == nil) {
    key = (id) ComGoogleProtobufNanoInternalNano_primitiveDefaultValueWithInt_(keyType);
  }
  if (value == nil) {
    value = (id) ComGoogleProtobufNanoInternalNano_primitiveDefaultValueWithInt_(valueType);
  }
...
jboolean ComGoogleProtobufNanoInternalNano_equalsMapValueWithId_withId_(id a, id b) {
  ...
  if ([a isKindOfClass:[IOSByteArray class]] && [b isKindOfClass:[IOSByteArray class]]) {
    return JavaUtilArrays_equalsWithByteArray_withByteArray_((IOSByteArray *) check_class_cast(a, [IOSByteArray class]), (IOSByteArray *) check_class_cast(b, [IOSByteArray class]));
  }
...
jint ComGoogleProtobufNanoInternalNano_hashCodeForMapWithId_(id o) {
  ...
  if ([o isKindOfClass:[IOSByteArray class]]) {
    return JavaUtilArrays_hashCodeWithByteArray_((IOSByteArray *) check_class_cast(o, [IOSByteArray class]));
  }
