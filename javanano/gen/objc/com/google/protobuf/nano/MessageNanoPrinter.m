...
inline NSString *ComGoogleProtobufNanoMessageNanoPrinter_get_INDENT(void);
...
inline jint ComGoogleProtobufNanoMessageNanoPrinter_get_MAX_STRING_LEN(void);
...
__attribute__((unused)) static ComGoogleProtobufNanoMessageNanoPrinter *new_ComGoogleProtobufNanoMessageNanoPrinter_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleProtobufNanoMessageNanoPrinter *create_ComGoogleProtobufNanoMessageNanoPrinter_init(void);
...
NSString *ComGoogleProtobufNanoMessageNanoPrinter_printWithComGoogleProtobufNanoMessageNano_(ComGoogleProtobufNanoMessageNano *message) {
  ...
  @catch (JavaLangIllegalAccessException *e) {
    return JreStrcat("$$", @"Error printing proto: ", [e getMessage]);
  }
...
void ComGoogleProtobufNanoMessageNanoPrinter_printWithNSString_withId_withJavaLangStringBuffer_withJavaLangStringBuffer_(NSString *identifier, id object, JavaLangStringBuffer *indentBuf, JavaLangStringBuffer *buf) {
  ...
  if (object == nil) {
    ...
    jint origIndentBufLength = [((JavaLangStringBuffer *) nil_chk(indentBuf)) java_length];
    if (identifier != nil) {
    ...
    IOSClass *clazz = [object java_getClass];
    {
      ...
      while (b__ < e__) {
        ...
        if ((modifiers & JavaLangReflectModifier_PUBLIC) == JavaLangReflectModifier_PUBLIC && (modifiers & JavaLangReflectModifier_STATIC) != JavaLangReflectModifier_STATIC && ![((NSString *) nil_chk(fieldName)) java_hasPrefix:@"_"] && ![fieldName java_hasSuffix:@"_"]) {
    ...
    }
    {
      ...
      while (b__ < e__) {
        ...
        if ([((NSString *) nil_chk(name)) java_hasPrefix:@"set"]) {
          NSString *subfieldName = [name java_substring:3];
    ...
    if ([object isKindOfClass:[NSString class]]) {
      NSString *stringMessage = ComGoogleProtobufNanoMessageNanoPrinter_sanitizeStringWithNSString_((NSString *) object);
...
NSString *ComGoogleProtobufNanoMessageNanoPrinter_deCamelCaseifyWithNSString_(NSString *identifier) {
  ...
  for (jint i = 0; i < [((NSString *) nil_chk(identifier)) java_length]; i++) {
...
NSString *ComGoogleProtobufNanoMessageNanoPrinter_sanitizeStringWithNSString_(NSString *str) {
  ComGoogleProtobufNanoMessageNanoPrinter_initialize();
  if (![((NSString *) nil_chk(str)) java_hasPrefix:@"http"] && [str java_length] > ComGoogleProtobufNanoMessageNanoPrinter_MAX_STRING_LEN) {
    str = JreStrcat("$$", [str java_substring:0 endIndex:ComGoogleProtobufNanoMessageNanoPrinter_MAX_STRING_LEN], @"[...]");
  }
  return ComGoogleProtobufNanoMessageNanoPrinter_escapeStringWithNSString_(str);
}
...
NSString *ComGoogleProtobufNanoMessageNanoPrinter_escapeStringWithNSString_(NSString *str) {
  ...
  for (jint i = 0; i < strLen; i++) {
    ...
    if (original >= ' ' && original <= '~' && original != '"' && original != '\'') {
      ...
      [b appendWithNSString:NSString_java_formatWithNSString_withNSObjectArray_(@"\\u%04x", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_((jint) original) } count:1 type:NSObject_class_()])];
    }
  }
...
void ComGoogleProtobufNanoMessageNanoPrinter_appendQuotedBytesWithByteArray_withJavaLangStringBuffer_(IOSByteArray *bytes, JavaLangStringBuffer *builder) {
  ...
  for (jint i = 0; i < bytes->size_; ++i) {
    ...
    if (ch == '\\' || ch == '"') {
      ...
      [builder appendWithNSString:NSString_java_formatWithNSString_withNSObjectArray_(@"\\%03o", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(ch) } count:1 type:NSObject_class_()])];
    }
  }
