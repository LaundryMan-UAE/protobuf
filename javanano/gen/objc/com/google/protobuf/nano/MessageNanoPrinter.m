...
static NSString *ComGoogleProtobufNanoMessageNanoPrinter_INDENT_ = @"  ";
J2OBJC_STATIC_FIELD_GETTER(ComGoogleProtobufNanoMessageNanoPrinter, INDENT_, NSString *)

J2OBJC_STATIC_FIELD_GETTER(ComGoogleProtobufNanoMessageNanoPrinter, MAX_STRING_LEN, jint)
...
void ComGoogleProtobufNanoMessageNanoPrinter_printWithNSString_withId_withJavaLangStringBuffer_withJavaLangStringBuffer_(NSString *identifier, id object, JavaLangStringBuffer *indentBuf, JavaLangStringBuffer *buf) {
  ...
  if (object == nil) {
    ...
    if (identifier != nil) {
      ...
      [indentBuf appendWithNSString:ComGoogleProtobufNanoMessageNanoPrinter_INDENT_];
    }
    ...
    }
    {
      ...
      while (b__ < e__) {
        ...
        if ([((NSString *) nil_chk(name)) hasPrefix:@"set"]) {
          ...
          if (![((JavaLangBoolean *) nil_chk((JavaLangBoolean *) check_class_cast([((JavaLangReflectMethod *) nil_chk(hazzer)) invokeWithId:object withNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]], [JavaLangBoolean class]))) booleanValue]) {
            continue;
          }
    ...
    if ([object isKindOfClass:[NSString class]]) {
      NSString *stringMessage = ComGoogleProtobufNanoMessageNanoPrinter_sanitizeStringWithNSString_((NSString *) check_class_cast(object, [NSString class]));
      ...
      ComGoogleProtobufNanoMessageNanoPrinter_appendQuotedBytesWithByteArray_withJavaLangStringBuffer_((IOSByteArray *) check_class_cast(object, [IOSByteArray class]), buf);
    }
    else {
