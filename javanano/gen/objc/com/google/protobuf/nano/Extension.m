...
//  source: /Users/marcussmith/Laundryman/Libraries/protobuf/javanano/src/main/java/com/google/protobuf/nano/Extension.java
//
...
__attribute__((unused)) static void ComGoogleProtobufNanoExtension_writeRepeatedDataWithId_withComGoogleProtobufNanoCodedOutputByteBufferNano_(ComGoogleProtobufNanoExtension *self, id array, ComGoogleProtobufNanoCodedOutputByteBufferNano *output);

__attribute__((unused)) static jint ComGoogleProtobufNanoExtension_computeRepeatedSerializedSizeWithId_(ComGoogleProtobufNanoExtension *self, id array);

__attribute__((unused)) static IOSObjectArray *ComGoogleProtobufNanoExtension__Annotations$0(void);

/*!
 @brief Represents an extension of a primitive (including enum) type.If there is no primitive
...
- (id)readDataWithComGoogleProtobufNanoCodedInputByteBufferNano:(ComGoogleProtobufNanoCodedInputByteBufferNano *)input {
  ...
  @catch (JavaLangInstantiationException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_withJavaLangThrowable_(JreStrcat("$@", @"Error creating instance of class ", messageType), e);
  }
  @catch (JavaLangIllegalAccessException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_withJavaLangThrowable_(JreStrcat("$@", @"Error creating instance of class ", messageType), e);
  }
  @catch (JavaIoIOException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_withJavaLangThrowable_(@"Error reading extension field", e);
  }
}
...
- (void)writeRepeatedDataWithId:(id)array
withComGoogleProtobufNanoCodedOutputByteBufferNano:(ComGoogleProtobufNanoCodedOutputByteBufferNano *)output {
  ComGoogleProtobufNanoExtension_writeRepeatedDataWithId_withComGoogleProtobufNanoCodedOutputByteBufferNano_(self, array, output);
}
...
- (jint)computeRepeatedSerializedSizeWithId:(id)array {
  return ComGoogleProtobufNanoExtension_computeRepeatedSerializedSizeWithId_(self, array);
}
...
void ComGoogleProtobufNanoExtension_writeRepeatedDataWithId_withComGoogleProtobufNanoCodedOutputByteBufferNano_(ComGoogleProtobufNanoExtension *self, id array, ComGoogleProtobufNanoCodedOutputByteBufferNano *output) {
...
jint ComGoogleProtobufNanoExtension_computeRepeatedSerializedSizeWithId_(ComGoogleProtobufNanoExtension *self, id array) {
  jint size = 0;
  jint arrayLength = JavaLangReflectArray_getLengthWithId_(array);
  for (jint i = 0; i < arrayLength; i++) {
    id element = JavaLangReflectArray_getWithId_withInt_(array, i);
